...
// wifi credentials
const char *ssid = "CHOOCHOO"; // Tu SSID
const char *password = "2238922181"; // Tu PWD del SSID
WiFiClient client;
// OpenWeather
String apiTemperature;
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=20.66682&lon=-103.39182&appid=c75e90b238ac935ccfdd5c63de2052cc"; //El path que usaste en el web para la tem de la API - TODO el path con http
// ThingSpeak
uint32_t channelNumber = 2317838; // Tu channel ID number de thingspeak
const char *writeAPIKey = "EWXLNA8RW4OK67E8"; // El API write de thingspeak
void setup()
{
Serial.begin(115200);
dht.begin();
...
// set a twittwer
String tweet = "Proyecto IoT, mensaje AUTOMATICO - La temperatura actual en mi ciudad es: " + apiTemperature + "*K";
ThingSpeak.setTwitterTweet("emilian63168837", tweet); // sustituir por el nombre de tu usuario de twitter
